...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculate() {
        ...
        if (firstCard == secondCard) {
            ...
            Card1.setImageResource(R.drawable.galaxy);
            Card2.setImageResource(R.drawable.galaxy);
            Card3.setImageResource(R.drawable.galaxy);
            Card4.setImageResource(R.drawable.galaxy);
            Card5.setImageResource(R.drawable.galaxy);
            Card6.setImageResource(R.drawable.galaxy);
            Card7.setImageResource(R.drawable.galaxy);
            Card8.setImageResource(R.drawable.galaxy);
            Card9.setImageResource(R.drawable.galaxy);
            Card10.setImageResource(R.drawable.galaxy);
            Card11.setImageResource(R.drawable.galaxy);
            Card12.setImageResource(R.drawable.galaxy);
        }
    ...
    private void frontOfCardsResources() {
        image101 = R.drawable.earth;
        image102 = R.drawable.mars;
        image103 = R.drawable.jupiter;
        image104 = R.drawable.venus;
        image105 = R.drawable.saturn;
        image106 = R.drawable.pluto;
        image201 = R.drawable.earth1;
        image202 = R.drawable.mars1;
        image203 = R.drawable.jupiter1;
        image204 = R.drawable.venus1;
        image205 = R.drawable.saturn1;
        image206 = R.drawable.pluto1;
    }
}